...
import com.song.es.config.ApplicationContextHolder;
import com.song.es.qo.PageResult;
import com.song.es.qo.QueryObject;
import com.song.es.repository.IBaseRepository;
import com.song.es.util.BeanUtil;
...
public class BaseRepositoryImpl<T> implements IBaseRepository<T> {
    ...
    /**
     * 父类的无参构造器会被子类调用
     * 通过子类@RepositoryName注解将注解内容赋值给变量
     */
